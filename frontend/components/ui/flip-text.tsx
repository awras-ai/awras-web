...
export function FlipText({
    ...
    return (
        <span // Changed from div to span to allow nesting inside h1
            className={cn(
                "flip-text-wrapper inline-block leading-none",
                className
            )}
            style={{ perspective: "1000px" }}
            aria-label={children} // SEO/Accessibility: Screen readers read "Awras"
        >
                        ...
                        {chars.map((char, charIndex) => {
                            ...
                            return (
                                <span
                                    ...
                                    data-char={char}
                                    aria-hidden="true" // Hide split/animated chars from screen readers
                                    style={
                                        {
