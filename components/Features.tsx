        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-32">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 font-display tracking-tighter">
                The Vision
              </h2>
              <p className="text-muted-foreground text-lg leading-relaxed">
                ...
                dialect.
                <br />
                The ultimate goal is to build an AI ecosystem that truly
                comprehends our language and culture.
              </p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <Card className="bg-secondary/30 border-none shadow-none rounded-none hover:bg-secondary/50 transition-colors duration-300">
